...
canvas.create_rectangle(50, 20, 100, 200, fill = 'red',
                        width = 10, dash = (4,2,1,1),
                        outline = 'green')
canvas.create_oval((200,0,300,100), fill = 'green')
canvas.create_arc((200,0,300,100), fill = 'red',
                  start = 45, extent = 140,
                  style = tk.CHORD, outline = 'red', width = 1)

# canvas.create_line((0,0,100,150), fill = 'blue')
# (x1,y1, x2,y2, x3,y3)
#canvas.create_polygon((0,0,100,200,300,50,150,-50), fill = 'grey')

# canvas.create_text((100,250), text = 'this is some text', fill = 'green', width = 10)
